...
* Relationships are uniquely identified by the UUIDs obtained from hashing the concatenation of their UUIDs. For example, the relationship between entities with UUIDs `123..` and `124..` is defined as `UUID(hex=MD5("123..-124.."))`.
